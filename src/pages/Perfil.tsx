  ...
  const fetchUserStats = async () => {
    ...
    try {
      ...
      const completedBooks =
        books?.filter((b) => b.reading_status === "completed").length || 0;
      const currentlyReading =
        books?.filter((b) => b.reading_status === "reading").length || 0;
          ...
          {recentActivity.length === 0 ? (
            <Card className="text-center py-12">
              <CardContent>
                ...
                <p className="text-muted-foreground">
                  Comece a ler e atualize seu progresso para ver suas atividades
                  aqui!
                </p>
              </CardContent>
            </Card>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <p className="font-medium">
                        Leu {activity.pages_read} páginas de "
                        {activity.books?.title}"
                      </p>
                      <p className="text-sm text-muted-foreground">
                        Progresso: {activity.previous_progress}% →{" "}
                        {activity.new_progress}%
                      </p>
                      <p className="text-xs text-muted-foreground">
